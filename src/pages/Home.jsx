              ...
              <ul className="ht-menu">
                ...
                <li>
                  ...
                  <div className="language ht-language">
                    <ul className="ht-setting-list">
                      <li className="active"><a href="#"><img src="assets/images/menu/flag-icon/1.jpg" alt />English</a></li>
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-md-4 text-center">
          <div className="single-banner">
            <a href="#">
              <img src="assets/images/banner/1_3.jpg" alt="Li's Static Banner" />
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-4 col-md-4 text-center pt-xs-30">
          <div className="single-banner">
            <a href="#">
              <img src="assets/images/banner/1_4.jpg" alt="Li's Static Banner" />
            </a>
          </div>
        </div>
        {/* Single Banner Area End Here */}
        ...
        <div className="col-lg-4 col-md-4 text-center pt-xs-30">
          <div className="single-banner">
            <a href="#">
              <img src="assets/images/banner/1_5.jpg" alt="Li's Static Banner" />
            </a>
          </div>
        </div>
        {/* Single Banner Area End Here */}
